        ...
        <section> {{-- input ข้อมูลนักศึกษา --}}
            ...
            <div class="row mx-2">
                ...
                <div id="form-check" class="form-check col-2">
                    <input id="mr" name="prefix" type="radio" class="form-check-input ms-1" value="MR" {{ old('prefix') == 'MR' ? 'checked' : '' }} required>
                ...
                <div id="form-check" class="form-check col-2">
                    <input id="miss" name="prefix" type="radio" class="form-check-input" value="MS" style="translate: -200% 0%" {{ old('prefix') == 'MS' ? 'checked' : '' }} required>
                ...
                <div class="col-6">
                    ...
                    <input type="text" class="form-control rounded-5 ps-4" name="student_id" placeholder="" value="{{ old('student_id') }}" maxlength="10" autocomplete="off">
                </div>
        ...
        <section> {{-- input ข้อมูลที่อยู่ --}}
            ...
            <div class="row mx-2">
                <div class="col-3">
                    ...
                    <input type="text" class="form-control rounded-5 ps-4" name="house_no" placeholder="" value="{{ old('house_no') }}" autocomplete="off" required>
                </div>
                <div class="col-3">
                    <label for="village_no" class="form-label">หมู่ที่</label>
                    <input type="text" class="form-control rounded-5 ps-4" name="village_no" placeholder="" value="{{ old('village_no') }}" autocomplete="off" required>
                </div>
                <div class="col-6">
