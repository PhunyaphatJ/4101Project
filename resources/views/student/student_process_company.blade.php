        ...
        <div class="d-flex gap-4 justify-content-center py-5">
            <div class="sidebar_color" style="width: 45%">
                <a id="bottom_menu" class="btn d-grid align-items-center mb-4 rounded-0 py-3" type="button"
                    href="/student/{{ $student_process_status }}/rec/student_process_company_rec" style="height: 85%">
            ...
            <div class="sidebar_color" style="width: 45%">
                <a id="bottom_menu" class="btn d-grid align-items-center mb-4 rounded-0 py-3" type="button"
                    href="/student/{{ $student_process_status }}/request/student_process_company_search_address"
                    style="height: 85%">
