        ...
        <div class="card sidebar_color sticky-top" style="border-radius: 20px">
            <div class="card-body mx-2">
                ...
                <ul class="list-group list-group-flush">
                    <a class="list-group-item p-3 my-1 @yield('manual')" href="/manual"><i
                    ...
                    <a class="list-group-item p-3 my-1 @yield('process')" href="/process"><i
                            class="bi bi-back ms-3 me-2"></i>process การฝึกงาน</a> {{-- process หมายถึงเมนูprocess การฝึกงาน --}}
                    <a class="list-group-item p-3 my-1 @yield('status')" href="/status"><i
